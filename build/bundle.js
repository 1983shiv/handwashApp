var app = (function () {
    ...
    /* src\components\HowTo.svelte generated by Svelte v3.38.2 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img src="handwashing.png" alt="Handwashing app" bp="offset-5@md 4@md 12@sm" class="svelte-10t3lmq"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src\components\ProgressBar.svelte generated by Svelte v3.38.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-10xms06");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-10xms06");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*myTimer*/ ctx[3]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondLeft, isRunning, progress, myTimer];
    }
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086">Sound Source</a></h5>`;
    			...
    			attr(h1, "class", "svelte-1sq38oz");
    			attr(footer, "class", "svelte-1sq38oz");
    		},
    		m(target, anchor) {
    ...
    class App extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { audio: 0 });
    	}
    }
